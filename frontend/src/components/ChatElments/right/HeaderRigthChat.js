...
const HeaderRigthChat = ({ socket }) => {
  ...
  const [usersConnect, setUsesConnect] = useState([]);
  ...
  const isOnline = usersConnect.find((user) => user.userId === actifUser._id);

  return (
    <div className=' bg-[#f0f2f5] h-full p-2'>
      <div className=' flex justify-between items-center'>
        ...
        <div className=' flex items-center space-x-6 px-5 opacity-70'>
          <button>
            <svg
              viewBox='0 0 24 24'
              height='24'
...
export default HeaderRigthChat;
